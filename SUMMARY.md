**PAXRAY: A Projected dataset for the segmentation of Anatomical structures in X-RAY data** is a dataset for a semantic segmentation task. It is used in the medical industry. 
